...
<template>
  <v-list lines="one" aria-label="gender list" aria-busy="true" class="checkbox-label">
    <v-list-item-title class="text-h5">Gender</v-list-item-title>
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox label="Male" density="compact" v-model="selectedGender" color="primary" value="male" hide-details> </v-checkbox>
    </v-list-item>
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox label="Female" density="compact" v-model="selectedGender" color="secondary" value="female" hide-details></v-checkbox>
    </v-list-item>
    <v-list-item class="pa-0">
      <v-checkbox label="Kids" density="compact" v-model="selectedGender" color="error" value="kids" hide-details></v-checkbox>
    </v-list-item>
  </v-list>
  <v-list lines="one" class="mb-3 checkbox-label" aria-label="categories list" aria-busy="true">
    <v-list-item-title class="text-h5">Categories</v-list-item-title>
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox label="All" density="compact" v-model="selectedCategory" color="primary" value="all" hide-details> </v-checkbox>
    </v-list-item>
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox
        label="Electronics"
    ...
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox label="Fashion" density="compact" v-model="selectedCategory" color="primary" value="fashion" hide-details></v-checkbox>
    </v-list-item>
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox label="Books" density="compact" v-model="selectedCategory" color="primary" value="books" hide-details></v-checkbox>
    </v-list-item>
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox label="Toys" density="compact" v-model="selectedCategory" color="primary" value="toys" hide-details></v-checkbox>
    </v-list-item>
    <v-list-item class="pa-0 mb-n2">
      <v-checkbox label="Kitchen" density="compact" v-model="selectedCategory" color="primary" value="kitchen" hide-details></v-checkbox>
    </v-list-item>
  </v-list>
  <div class="mb-3">
  ...
  <v-btn color="primary" variant="text" block class="mt-5">Reset all filters</v-btn>
</template>
<style lang="scss">
.custom-accordion {
  padding: 18px 2px;
