        ...
        <v-col lg="12">
          <v-row class="align-center mb-sm-n3 mb-n1">
            ...
            <v-col cols="12" sm="9" class="pt-sm-3 pt-0">
              <v-text-field hide-details color="primary" placeholder="Enter your first name" variant="outlined"></v-text-field>
            </v-col>
          </v-row>
          <v-row class="align-center mb-sm-n3 mb-n1">
            <v-col cols="12" sm="3" class="pb-sm-3 pb-1">
            ...
            <v-col cols="12" sm="9" class="pt-sm-3 pt-0">
              <v-text-field hide-details color="primary" placeholder="Enter your last name" variant="outlined"></v-text-field>
            </v-col>
          </v-row>
          <v-row class="align-center mb-sm-n3 mb-n1">
            <v-col cols="12" sm="3" class="pb-sm-3 pb-1">
            ...
            <v-col cols="12" sm="9" class="pt-sm-3 pt-0">
              <v-text-field hide-details color="primary" type="email" placeholder="Enter email id" variant="outlined"></v-text-field>
            </v-col>
          </v-row>
          <v-row class="align-center mb-sm-n3 mb-n1">
            <v-col cols="12" sm="3" class="pb-sm-3 pb-1">
            ...
            <v-col cols="12" sm="9" class="pt-sm-3 pt-0">
              <v-row class="align-center">
                ...
                <v-col cols="4" class="ps-0">
                  <v-text-field hide-details color="primary" type="number" placeholder="2023" variant="outlined">
                    <template v-slot:append-inner>
                      <AppstoreOutlined class="text-lightText" />
                    </template>
                  </v-text-field>
          ...
          <v-row class="align-center mb-sm-n3 mb-n1">
            ...
            <v-col cols="12" sm="9" class="pt-sm-3 pt-0">
              <v-text-field hide-details color="primary" placeholder="Enter city name" variant="outlined"></v-text-field>
            </v-col>
          </v-row>
          <v-checkbox
            class="mt-3"
          ...
          <v-row class="mt-2">
            <v-col cols="12" class="text-end">
              <v-btn color="secondary" class="me-2" variant="outlined">Cancel</v-btn>
