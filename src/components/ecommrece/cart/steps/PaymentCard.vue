                      ...
                      <div class="d-flex align-center w-100">
                        <div class="flex-1-1">
                          <div class="d-flex justify-space-between">
                            <h6 class="text-subtitle-1 mb-1">Credit Card</h6>
                            <div class="ms-auto">
                  ...
                  <v-radio value="paypal" color="primary" class="label-op-1">
                    <template v-slot:label>
                      <div class="d-flex align-start w-100">
                        <div>
                          <h6 class="text-subtitle-1 mb-1">Pay with PayPal</h6>
                ...
                <div class="py-5 px-4 border payment-method rounded-md">
                  <v-radio value="cash" color="primary" class="label-op-1">
                    <template v-slot:label>
                      <div class="d-flex align-center w-100">
                        <div>
                          <h6 class="text-subtitle-1 mb-1">Cash on Delivery</h6>
            ...
            <v-card-item class="py-3 px-0">
                ...
                <v-col md="7" cols="12" class="pt-md-3 pt-0">
                  <v-row class="align-center">
                    <v-col cols="5" class="pe-0">
                      <v-text-field single-line type="number" placeholder="12" variant="outlined" hide-details></v-text-field>
                    </v-col>
                    <v-col cols="2" class="pa-0 text-center"> / </v-col>
                    <v-col cols="5" class="ps-0">
                      <v-text-field single-line type="number" placeholder="2021" variant="outlined" hide-details></v-text-field>
                    </v-col>
                  </v-row>
                </v-col>
              </v-row>
              ...
              <v-row class="mb-md-n3 mb-n1">
                ...
                <v-col cols="12" class="text-end">
                  <v-btn variant="outlined" class="me-2" color="secondary">Cancel</v-btn>
